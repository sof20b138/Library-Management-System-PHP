  ...
  <div class="content-wrapper">
    <div class="container form-container">
      ...
      <div class="row pad-botm">
        <div class="col-md-12">
          <h4 class="header-line text-center">User Password Recovery</h4>
        </div>
      </div>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <form role="form" name="chngpwd" method="post" onSubmit="return valid();">
                ...
                <button type="submit" name="change" class="btn btn-info">Chnage Password</button> | <a href="userlogin.php">Login</a>
              </form>
            </div>
          </div>
        </div>
